...
## aus eingebauter Version und nachgeladenem Update (boot.gd schreibt version.txt
...
static func version() -> String:
	...
	if not OS.has_feature("template") or not FileAccess.file_exists("user://game.pck"):
		return eingebaut
