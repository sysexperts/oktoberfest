...
| Controller-Glyphen | `assets/ui/glyphen/{xbox,playstation,deck}/**` (45 Bilder) und `assets/fonts/glyphen/*.ttf` (3 Schriften) | Kenney „Input Prompts" 1.5, kenney.nl | **CC0** — kommerziell nutzbar, keine Nennung nötig | `docs/lizenzen/kenney-input-prompts-CC0.txt` | ✅ |
